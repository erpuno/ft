...
документ : {token, {document, TokenLine}}.
резалт   : {token, {result, TokenLine}}.
модуль   : {token, {module, TokenLine}}.
форма    : {token, {form, TokenLine}}.
запис    : {token, {'record', TokenLine}}.
імпорт   : {token, {'import', TokenLine}}.
процеси  : {token, {bpe, TokenLine}}.
схема    : {token, {kvs, TokenLine}}.
фрейм    : {token, {nitro, TokenLine}}.
функція  : {token, {'fun', TokenLine}}.
код      : {token, {'begin', TokenLine}}.
ок       : {token, {'end', TokenLine}}.
маршрут  : {token, {route, TokenLine}}.
нотіс    : {token, {notice, TokenLine}}.
